...
for TASK in "${TASKS[@]}"; do
  for TEST_CASE in "${TEST_CASES[@]}"; do
    case "$TEST_CASE" in
        "train_hataformer" | "evaluate_hataformer" )
            EVENT="common"
            ;;
        "tuning_train_hataformer" | "tuning_evaluate_hataformer" )
            EVENT="hyperparam"
            ;;
        "ablation_train_hataformer" | "ablation_evaluate_hataformer" )
            EVENT="ablation"
            ;;
        *)
            EVENT="default"
